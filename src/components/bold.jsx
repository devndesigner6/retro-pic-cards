...
function Bold({onChange, value}) {
  ...
  return (
    <div className='flex flex-col gap-3 justify-center items-center'>
        <div>
            <h1 className='text-2xl mb-2 bg-gradient-to-r from-neutral-800 to-neutral-600 bg-clip-text text-transparent tracking-tight' style={{fontFamily: "'Instrument Serif', serif", fontWeight: 600}}>Text Style</h1>
